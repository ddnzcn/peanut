...
namespace atlas2d
{
    ...
    static inline void BuildAtlasQuad(const atlas2d::AtlasSprite &sprite,
                                      float anchorX,
                                      float anchorY,
                                      float scale,
                                      SpriteVertex out[4])
    ...
    static inline void RotateAtlasQuadUVs(SpriteVertex quad[4], SpriteRotation rotation)
    {
    ...
    static inline void RotateAtlasQuadPositions(SpriteVertex quad[4],
                                                float pivotX,
                                                float pivotY,
                                                float radians)
    {
    ...
    static inline void DrawAtlasSprite(
        GSGLOBAL *gsGlobal,
    ...
    static inline void DrawAtlasSpriteRotated(
        GSGLOBAL *gsGlobal,
        const atlas2d::AtlasSprite &sprite,
        GSTEXTURE *texture,
        float anchorX,
